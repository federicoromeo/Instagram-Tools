...
if __name__ == '__main__':
    try:
        ...
        browser.switch_to.window(browser.window_handles[1])  #-1 is sure
        ...
        code_label = browser.find_element_by_xpath("/html/body/div[1]/section/main/div/article/div/div[1]/div[2]/form/div/div[1]/input")
        code_label.send_keys(autenthication_code)
        code_label.se
        ...
        #TRY:   browser.execute_script("arguments[0].click();", element)
